...
while True:
	...
	result = input("Graph structure created and saved as {}.pkl.".format(graph_model_name), " Would you \
		like to add to it by choosing another combination of data type, data file, geographic aggregator, and features? \
		Answer 'yes' or 'no'")
